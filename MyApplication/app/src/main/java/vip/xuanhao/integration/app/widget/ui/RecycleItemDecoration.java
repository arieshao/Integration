package vip.xuanhao.integration.app.widget.ui;
...
/**
 * Created by Xuanhao on 2016/8/3.
 */
...
public class RecycleItemDecoration extends RecyclerView.ItemDecoration {
     ...
     */
    public RecycleItemDecoration(Context context, int orientation, int drawableId) {
     ...
     */
    public RecycleItemDecoration(Context context, int orientation, int dividerHeight, int dividerColor) {
        this(context, orientation);
